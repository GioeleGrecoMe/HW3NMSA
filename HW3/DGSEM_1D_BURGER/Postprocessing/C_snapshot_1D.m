...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure(1);
if(strcmp(Dati.fem,'P0'))
   values = full(uh);
   x = []; val = [];
   for i = 1 : femregion.ne
       xa = femregion.coord(i) - femregion.h*0.5;
       xb = femregion.coord(i) + femregion.h*0.5;
       x = [x, [xa xb]];
       val = [val, [values(i) values(i)]];
   end    
    plot(x,val, 'Color','blue' );
